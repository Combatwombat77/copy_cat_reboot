                                ...
                                children: <Widget>[
                                  ...
                                  Row(
                                    children: <Widget>[
                                      FlatButton(
                                        color: Colors.white,
                                        child: Text("PROJECT DETAILS", style: TextStyle(color: Uidata.primaryColor),),
                                        onPressed: (){
                                           Navigator.push(context, MaterialPageRoute(builder: (context) => ProjectDash( notes[index]['ModelTitle'],notes[index]['id'])));                                                          
                                      },
                                    ),
                                    FlatButton(
                                      color: Colors.white,
                                      child: Text("", style: TextStyle(color: Uidata.primaryColor),),
                                      onPressed: (){
                                    ...
                                    IconButton(
                                       ...
                                       onPressed: (){
                                         DBManagerProjects.deleteItem(notes[index]['id']);
                                     },
                                    ),
                                  ],
                                )
