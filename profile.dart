...
final startColor = Color(0xFF2196F3);
final endColor = Color(0xFF64B5F60);
        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                  'To provide tools that allow users to adequately plan, evaluate and adapt business strategy in a simple and accountable format.')
            ],
          ),
        ),
        Column(
